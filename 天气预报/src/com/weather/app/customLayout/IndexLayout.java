...
import com.weather.app.model.WeatherIndex;
...
public class IndexLayout extends LinearLayout{
    ...
    private View indexItemView1;
    private View indexItemView2;
    private View indexItemView3;
    private View indexItemView4;
    ...
    private  void init(){
        ...
        indexItemView1 = findViewById(R.id.index_item_ly_1);
        indexItemView2 = findViewById(R.id.index_item_ly_2);
        indexItemView3 = findViewById(R.id.index_item_ly_3);
        indexItemView4 = findViewById(R.id.index_item_ly_4);
